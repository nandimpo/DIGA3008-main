    ...
    <>
      <header className="design-header">
        ...
        <main className="design-content">
          ...
          <section className="inspiration-block">
            <h2>Case Study Wireframes</h2>
            <p className="p-summary">
              Wireframing isn't just for this site, it's the first step on every project. Here are a few pages
              pulled straight from my working files for ABSA NextGen, I'Styla Senkosi, and Rock Creative Agency.
            </p>
            <div className="wireframe-gallery">
              <img src="/Images/DesignProcess/_Visual Design Document (VDD)/12.png" alt="I'Styla Senkosi chapter wireframe sketches" />
              <img src="/Images/DesignProcess/ABSA NEXT GEN/Studios/WEBSITE SITEMAP (Community).png" alt="ABSA NextGen website sitemap" />
              <img src="/Images/DesignProcess/ABSA NEXT GEN/Landing/Responsive Wireframes (Community).png" alt="ABSA NextGen landing page wireframes" />
              <img src="/Images/DesignProcess/Wireframes - Rock creative agency/Screenshot 2026-08-24 004406.png" alt="Rock Creative Agency annotated desktop wireframe" />
              <img src="/Images/DesignProcess/Wireframes - Rock creative agency/Screenshot 2026-08-24 004413.png" alt="Rock Creative Agency annotated mobile wireframe" />
            </div>
          </section>
