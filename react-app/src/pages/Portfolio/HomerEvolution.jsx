    ...
    <>
      <main className="project-row-section">
        <div className="notebook-sheet">
          ...
          <img className="project-detail-hero" src="/Images/Portfolio/Homer front walk cycle.gif" alt="Homer Simpson walk cycle animation" />
          ...
          <p className="project-detail-note">
            More process shots coming soon — early sketches, reference frames, and in-progress screenshots
            would make a great addition here.
          </p>
        </div>
      </main>
