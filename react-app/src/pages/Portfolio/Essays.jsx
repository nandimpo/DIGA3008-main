  ...
  return (
    <>
      <div className="blog-article-wrapper">
          <h1>Previous Work</h1>
          <p className="blog-date">Updated: 2026</p>

          <h2>Profile</h2>
          <p>A creative professional with experience in teaching, writing, editorial management, communications, marketing, and AI training. Skilled in project management, content production, social media strategy, and curating digital and written materials.</p>
