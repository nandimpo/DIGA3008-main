    ...
    <>
      <article className="blog-article-wrapper h-entry">
          <div className="e-content">
            ...
            <p className="p-summary">Pick one that appeals to you. You must engage critically with the reading and do more research where required.</p>

            <p className="p-summary">I chose the text by Sasha Costanza-Chock because it focuses on community-led practices to foster design justice. This resonates with me because I believe the more diverse opinions there are in design, the better it is because it caters to more people.</p>
            ...
            <h3>References</h3>
            <ul>
              <li>Costanza-Chock, S. (2020) <em>Design Justice: Community-Led Practices to Build the Worlds We Need</em>. Cambridge, Massachusetts: The MIT Press.</li>
              <li>Mok, J. (2023) 'Defining Ethical UX: The Intersection of Morality and Design', UX Primer, 29 June. Available at: [URL] (Accessed: 21 April 2025).</li>
            </ul>
          </div>
        </article>

        <div className="next-blog-container">
          <Link to="/blogs/7" className="next-blog-btn">Previous Blog</Link>
          <Link to="/blogs/9" className="next-blog-btn">Next Blog</Link>
        </div>
    </>
  );
}
